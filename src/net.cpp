...
static const char *strDNSSeed[][2] = {
    {"PlatinumCoin.tk", "PlatinumCoinseed.tk"},
    {"node27.host1free.com", "node27.host1free.com"},
    {"80.138.23.181", "80.138.23.181"},
//    {"PlatinumCoin.com", "dnsseed.PlatinumCoin.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PlatinumCoin is probably already running."), addrBind.ToString().c_str());
        else
...
bool StopNode()
{
    ...
    if (vnThreadsRunning[THREAD_MINER] > 0) printf("ThreadPlatinumCoinMiner still running\n");
